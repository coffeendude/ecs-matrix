...
const draw = () => {
    ...
    for (let z = 0; z <= matrixHappy.length; z++) {
        ...
        const cheers = 'HIRE ANDREW BROUGHT'.charAt(z);
        // const cheers = 'HIRE ANDREW'.charAt(z);
        const wish = 'HEALTH-WEALTH-JOY!'.charAt(z)
        const peace = 'HIRE ANDREW'.charAt(z)
        const spread = '   ' + cheers + '                                 ' + cheers + '                                   ' + peace + '                    ' + text2 + '                 ' + cheers + '                    ' + peace + '                            ' + cheers + '              ' + text2;
